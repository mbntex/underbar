(function() {
  ...
  _.reject = function(collection, test) {
    return _.filter(collection, function(thing) {return !test(thing)});
  };
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    if (arguments.length < 3) {
      ...
      for (var i = 0; i < array.length; i++) {
        ...
        if (copy === true) {ret.push(iterator(array[i]));}
        copy = true;
      }
      return ret;
    }
  ...
  _.map = function(collection, iterator) {
    ...
    var ret = [];
    for (var i = 0; i < collection.length; i ++) {
      ret.push(iterator(collection[i]));
    }
    return ret;
  };
...
//   var start = null;
//   if (accumulator) { start = accumulator };
//   if (Array.isArray(collection)) {
//     for (var i = 0; i < collection.length; i++) {
//       start += iterator(accumulator, collection[i], i, collection);
//     }
//     return start;
//   }
// };
...
_.reduce = function(collection, iterator, accumulator) {
    var enoughArguments = arguments.length < 3;
  ...
  _.every = function(collection, iterator) {
    var answer = true;
    if (!iterator) {iterator = function(val) {
      return val;
    }}
    if (Array.isArray(collection)) {
      for (var i = 0; i < collection.length; i++) {
        if (!iterator(collection[i])) {answer = false;}
      }
    }
    return answer;
  };
  ...
  _.some = function(collection, iterator) {
    ...
    var answer = false;
    for (var i = 0; i < collection.length; i++) {
      if (iterator(collection[i])) { answer = true; };
    }
    return answer; 
  };
  ...
  _.shuffle = function(array) {
    ...
    var ret = [];
    for (var i = 0; i < array.length; i ++) {
      var roundRandom = Math.floor(Math.random() * temp.length);
      var piece = temp.splice(roundRandom, 1);
      ret.push(piece[0]);
    }
    return ret;
  };
